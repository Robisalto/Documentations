...
<iframe src="2021-06-24-POEI-Ansible/Formation_Ansible-Pierre_SABLE.pdf"></iframe>

Lien: [Formation_Ansible-Pierre_SABLE.pdf](2021-06-21-POEI-Ansible/Formation_Ansible-Pierre_SABLE.pdf)

## Fichiers de configuration

<iframe src="2021-06-24-POEI-Ansible/poec_devops_ansible"></iframe>

### Organisation des fichiers

```bash
tree -L 2 poec_devops_ansible/
poec_devops_ansible/
├── Diagramme_ansible.drawio
├── Diagramme_ansible.png
├── Diagramme_bootstrap_ansible.png
├── README.md
├── ansible.cfg
